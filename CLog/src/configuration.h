...
namespace CLog
{
    struct enable_time          {}; struct disable_time             {};

    struct enable_thread_id     {}; struct disable_thread_id        {};
    struct enable_process_id    {}; struct disable_process_id       {};

    struct enable_local_time    {}; struct disable_local_time       {};
    struct enable_precise_units {}; struct disable_precise_units    {};
